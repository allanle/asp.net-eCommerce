...
namespace eCommerce.Model
{
    public class Basket
    {
        ...
        public Basket()
        {
            ...
            this._basketVouchers = new List<BasketVoucher>();
        }

        public decimal BasketTotal()
        {
            decimal? total = (from item in BasketItem
        ...
        public virtual ICollection<BasketItem> BasketItem { get { return _basketItems; } set { _basketItems = value.ToList(); } }
